library light_bottom_navigation_bar;
...
class LightBottomNavigationBar extends StatefulWidget {
  ///The Constructor of LightBottomNavigationBar.
  ///items is required.
  LightBottomNavigationBar({super.key, 
    required this.items,
    this.currentIndex = 0,
    this.height = 70.0,
  ...
  final List<LightBottomNavigationBarItem> items;
  ...
  State<StatefulWidget> createState() => _LightBottomNavigationBarState();
}

/* LightBottomNavigationBar Widget Class */

/// This class is represent BottomNavigationBar Widget.
class _LightBottomNavigationBarState extends State<LightBottomNavigationBar> {
  /// This class is represent BottomNavigationBar Widget.
  int selected = 0;
  ...
  /// using the widget.
  LightBottomNavigationBar get widget => super.widget;
...
class LightNavItem extends StatelessWidget {
  ///The Constructor of LightNavItem.
  ...
  ///[item] LightNavItem object which contains all of data to display.
  final LightBottomNavigationBarItem item;
...
/// A tab to display in LightBottomNavigationBar.
class LightBottomNavigationBarItem {
